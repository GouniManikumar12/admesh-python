...
class RecommendResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> RecommendResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/admesh-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> RecommendResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/admesh-python#with_streaming_response
        """
